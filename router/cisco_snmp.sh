...
VERSION="1.4" # updated 24/11/12 to include decoding of any local users.


# user config settings
COM_PASS="/root/Desktop/Attack/router/snmp_default_pass.txt" #location of snmp communities to try
